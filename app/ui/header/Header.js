    ...
    <div className="mx-auto w-full max-w-6xl pb-12">
      <div className="grid gap-6  md:grid-cols-[180px_1fr] lg:grid-cols-[250px_1fr]">
        <nav className=" hidden  md:grid gap-4  border-r p-8">
          <div className="flex flex-col gap-6 text-muted-foreground font-semibold">
        ...
        <div className="mt-8">
          ...
          >
            ...
            <CarouselPrevious className="absolute left-4 top-1/2 transform -translate-y-1/2 z-10 bg-[#ff5252] outline-none hover:bg-[#ff5252] text-white" />
            <CarouselNext className="absolute right-4 top-1/2 transform -translate-y-1/2 z-10 bg-[#ff5252] outline-none hover:bg-[#ff5252] text-white" />
          </Carousel>
        </div>
      </div>
    </div>
